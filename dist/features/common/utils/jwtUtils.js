...
const pathToPrivKey = path.join(__dirname, "..", "..", "..", 
// "..",
"id_rsa_priv.pem");
const pathToPubKey = path.join(__dirname, "..", "..", "..", 
// "..",
"id_rsa_pub.pem");
 ...
 */
export function validPassword(password, passwordHashsed) {
 ...
 */
export function issueJWT(username) {
    const expiresIn = "1y";
    const payload = {
        sub: username,
        iat: Date.now(),
